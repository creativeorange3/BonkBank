                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    ...
                    {!hideSignin &&
                      ...
                      >
                        <li>
                          <DomLink to={{ pathname: "https://dexscreener.com/bsc/0x766eeF40920F18d240EFd53D89D700D6FFb13cbD" }} target="_blank" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu} style={{color: 'black !important'}}>Contract</DomLink>
                        </li>
                        <li>
                          <DomLink to={{ pathname: "https://poocoin.app/tokens/0x766eeF40920F18d240EFd53D89D700D6FFb13cbD" }} target="_blank" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>Buy</DomLink>
                        </li>
                      </ul>}
                  </div>
                </nav>
